// stolen from https://github.com/MyLegGuy/VNDSVitaConverter/blob/master/LegArchive.cs
using System;
using System.IO;
...
class LegArchive{
	...
	public LegArchive(string _filename){
	...
	public void addFile(string _filename, string _referFilename){
		...
		filenameList.Add(_referFilename);
